...
// 3944
static BYTE original_3944_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_3944_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// 4034, 4132
static BYTE original_4034_4132_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_4034_4132_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// Complex 4627
static BYTE original_4627_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_4627_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// 4817
static BYTE original_4817_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_4817_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// 5101
static BYTE original_5101_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_5101_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// 5530
static BYTE original_5530_Bytes[70] = {
...
static BYTE search_5530_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x00, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x56, 0x01, 0x00, 0x00, 0x8B,
...
// 5713, 5838 kernels
static BYTE original_5713_5838_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x00, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x56, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_5713_5838_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x00, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x56, 0x01, 0x00, 0x00, 0x8B,
...
// X2_5035 kernel
static BYTE original_X25035_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_X25035_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
// X3 kernel
static BYTE original_X3_Bytes[70] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
static BYTE search_X3_Bytes[57] = {
    0x55, 0x8B, 0xEC, 0x81, 0xEC, 0x04, 0x01, 0x00, 0x00, 0x8B, 0x45, 0x08,
    0x3D, 0x04, 0x01, 0x00, 0x00, 0x53, 0x75, 0x32, 0x8B, 0x4D, 0x18, 0x85,
    0xC9, 0x6A, 0x04, 0x58, 0x74, 0x02, 0x89, 0x01, 0x39, 0x45, 0x14, 0x73,
    0x0A, 0xB8, 0x23, 0x00, 0x00, 0xC0, 0xE9, 0x59, 0x01, 0x00, 0x00, 0x8B,
...
CStdString CUtil::ReadFileToString(const CStdString& path)
{
    CFile file;
    CStdString fileData;
    if (file.Open(path))
    {
        ...
        if (fileSize > 0)
        {
            ...
            vector<char> buffer(dataSize + 1);
            ssize_t bytesRead = file.Read(&buffer[0], dataSize);
            if (bytesRead > 0)
            {
                buffer[bytesRead] = '\0';
                fileData = &buffer[0];
...
bool CUtil::PatchCountryVideo(F_COUNTRY Country, F_VIDEO Video) {
  ...
  kernelSearchMap["1.0.3944.1"] = search_3944_Bytes;
  kernelSearchMap["1.0.4034.1"] = search_4034_4132_Bytes;
  kernelSearchMap["1.0.4132.1"] = search_4034_4132_Bytes;
  kernelSearchMap["1.0.4627.1"] = search_4627_Bytes;
  kernelSearchMap["1.0.4817.1"] = search_4817_Bytes;
  kernelSearchMap["1.0.5101.1"] = search_5101_Bytes;
  kernelSearchMap["1.0.5530.1"] = search_5530_Bytes;
  kernelSearchMap["1.0.5713.1"] = search_5713_5838_Bytes;
  kernelSearchMap["1.0.5838.1"] = search_5713_5838_Bytes;
  kernelSearchMap["1.0.5034.1"] = search_X3_Bytes;
  kernelSearchMap["1.0.5035.1"] = search_X25035_Bytes;
  // kernelSearchMap["1.0.8008.135"] = search_Cerbios24_Bytes;
...
void CUtil::RemoveKernelPatch()
{
  ...
  kernelResetMap["1.0.3944.1"] = original_3944_Bytes;
  kernelResetMap["1.0.4034.1"] = original_4034_4132_Bytes;
  kernelResetMap["1.0.4132.1"] = original_4034_4132_Bytes;
  kernelResetMap["1.0.4627.1"] = original_4627_Bytes;
  kernelResetMap["1.0.4817.1"] = original_4817_Bytes;
  kernelResetMap["1.0.5101.1"] = original_5101_Bytes;
  kernelResetMap["1.0.5530.1"] = original_5530_Bytes;
  kernelResetMap["1.0.5713.1"] = original_5713_5838_Bytes;
  kernelResetMap["1.0.5838.1"] = original_5713_5838_Bytes;
  kernelResetMap["1.0.5034.1"] = original_X3_Bytes;
  kernelResetMap["1.0.5035.1"] = original_X25035_Bytes;
  // kernelResetMap["1.0.8008.135"] = original_Cerbios24_Bytes;  // Uncomment if needed
...
void CUtil::RunShortcut(const char* szShortcutPath)
{
  ...
  if ( shortcut.Create(szShortcutPath))
  {
    ...
    if (!shortcut.m_strCustomGame.IsEmpty())
    {
      ...
      // Remove \\ if found at the end of the path, this is what caused it to fail on second launch of a shortcut
      int len = strlen(remap_path);
      if (len > 0 && remap_path[len - 1] == '\\')
        remap_path[len - 1] = 0;
    ...
    CLog::Log(LOGDEBUG, "Remap D:\\ as: %s", data.szRemap_D_As);
    CLog::Log(LOGDEBUG, "Launch XBE on exit: %s", data.szLaunchXBEOnExit);
    CLog::Log(LOGDEBUG, "ExecutionType: %d", data.executionType);
    CLog::Log(LOGDEBUG, "Magic: 0x%08X", data.magic);
